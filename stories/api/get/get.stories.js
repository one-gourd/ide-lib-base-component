...
import { BaseComponentFactory } from '../../../src';
import { modelPropsGen } from '../../helper';

const {
  BaseComponentWithStore: BaseComponentWithStore1,
  client: client1
} = BaseComponentFactory();

// const {
//   BaseComponentWithStore: BaseComponentWithStore2,
//   client: client2
// } = BaseComponentFactory();
  ...
  .addWithJSX('/model 获取属性信息', () => {
    return (
      <Row style={styles.demoWrap}>
        ...
        <Col span={24}>
          <BaseComponentWithStore1 onClick={onClick} />
        </Col>
      </Row>
    );
  });